...
router.put("/admin/user/:id", isAuthenticated, authorizeRoles("admin"), adminEditUser);
router.put("/admin/user/role", isAuthenticated, authorizeRoles("admin"), adminEditRole);
