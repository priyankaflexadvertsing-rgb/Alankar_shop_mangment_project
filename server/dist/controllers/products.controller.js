...
export const getAllProducts = CatchAsyncError(async (_req, res) => {
...
export const updateProduct = CatchAsyncError(async (req, res, next) => {
    ...
    const updatedProduct = await ProductFileModel.findByIdAndUpdate(req.params.id, req.body, { new: true, runValidators: true });
    res.status(200).json({
        success: true,
