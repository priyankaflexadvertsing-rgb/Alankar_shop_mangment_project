            ...
            <div className="w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-sm p-8">
                 <div>
                        <button className={`w-full flex bg-gray-100 shadow-lg items-center justify-center text-black font-semibold cursor-pointer py-2 rounded-md transition
                            ${loading ? "opacity-60 cursor-not-allowed" : "hover:bg-black hover:text-white"}`} onClick={() => window.open(`http://alankar-shop-mangment-project.onrender.com/auth/google`, "_self")}>
