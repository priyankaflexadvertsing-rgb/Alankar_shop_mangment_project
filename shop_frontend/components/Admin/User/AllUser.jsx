...
const AllUser = ({ user }) => {
    ...
    const toggleUser = (item) => {
        if (selectedUser?._id === item._id) {
            ...
            setSelectedUser(item); // show details
        }
    };
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div>
                                            {user.role === "admin" && (
                                                <button
                                                    className="bg-blue-500 text-white mr-2 py-2 px-4 rounded-lg"
                                                    onClick={() =>
                                                        setEditData({
                                                            userId: item._id,
                                                            fields:
                                            ...
                                            <button
                                                className="bg-red-500 text-white cursor-pointer py-2 px-4 rounded-lg"
                                    ...
                                    {/* DETAILS */}
                                    {selectedUser?._id === item._id && (
                                        <div className="mt-4 bg-gray-50 border rounded-xl p-4 flex gap-4">
                                            <FileViewer
                                                files={convertPrintingToFiles(
                                                    item.printing
                                                )}
                                                name={item.name}
                                            />
